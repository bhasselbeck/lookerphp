...
class LDAPConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'groups' => '\Looker\Model\LDAPGroupRead[]',
        'groups_with_role_ids' => '\Looker\Model\LDAPGroupWrite[]',
        ...
        'user_attributes' => '\Looker\Model\LDAPUserAttributeRead[]',
        'user_attributes_with_ids' => '\Looker\Model\LDAPUserAttributeWrite[]',
        'url' => 'string',
        'can' => 'map[string,bool]'
    ];
     ...
     *
     * @param \Looker\Model\Group[] $default_new_user_groups (Read-only) Groups that will be applied to new users the first time they login via LDAP
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\Role[] $default_new_user_roles (Read-only) Roles that will be applied to new users the first time they login via LDAP
     *
     * @return $this
     */
     ...
     * Gets groups
     *
     * @return \Looker\Model\LDAPGroupRead[]
     */
     ...
     * Sets groups
     *
     * @param \Looker\Model\LDAPGroupRead[] $groups (Read-only) Array of mappings between LDAP Groups and Looker Roles
     *
     * @return $this
     */
     ...
     *
     * @return \Looker\Model\LDAPGroupWrite[]
     */
     ...
     *
     * @param \Looker\Model\LDAPGroupWrite[] $groups_with_role_ids (Read/Write) Array of mappings between LDAP Groups and arrays of Looker Role ids
     *
     * @return $this
     */
     ...
     *
     * @return \Looker\Model\LDAPUserAttributeRead[]
     */
     ...
     *
     * @param \Looker\Model\LDAPUserAttributeRead[] $user_attributes (Read-only) Array of mappings between LDAP User Attributes and Looker User Attributes
     *
     * @return $this
     */
     ...
     *
     * @return \Looker\Model\LDAPUserAttributeWrite[]
     */
     ...
     *
     * @param \Looker\Model\LDAPUserAttributeWrite[] $user_attributes_with_ids (Read/Write) Array of mappings between LDAP User Attributes and arrays of Looker User Attribute ids
     *
     * @return $this
     */
