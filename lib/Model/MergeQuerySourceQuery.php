...
class MergeQuerySourceQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'query_id' => 'int',
        'name' => 'string',
        'merge_fields' => '\Swagger\Client\Model\MergeFields[]',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets merge_fields
     *
     * @return \Swagger\Client\Model\MergeFields[]
     */
     ...
     * Sets merge_fields
     *
     * @param \Swagger\Client\Model\MergeFields[] $merge_fields An array defining which fields of the source query are mapped onto fields of the merge query
     *
     * @return $this
     */
