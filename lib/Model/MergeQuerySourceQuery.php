...
class MergeQuerySourceQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'query_id' => 'int',
        'name' => 'string',
        'merge_fields' => '\Looker\Model\MergeFields[]',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets merge_fields
     *
     * @return \Looker\Model\MergeFields[]
     */
     ...
     * Sets merge_fields
     *
     * @param \Looker\Model\MergeFields[] $merge_fields An array defining which fields of the source query are mapped onto fields of the merge query
     *
     * @return $this
     */
