...
class Integration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'enabled' => 'bool',
        'params' => '\Looker\Model\IntegrationParam[]',
        ...
        'icon_url' => 'string',
        'required_fields' => '\Looker\Model\IntegrationRequiredField[]',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets params
     *
     * @return \Looker\Model\IntegrationParam[]
     */
     ...
     * Sets params
     *
     * @param \Looker\Model\IntegrationParam[] $params Array of params for the integration.
     *
     * @return $this
     */
     ...
     *
     * @return \Looker\Model\IntegrationRequiredField[]
     */
     ...
     *
     * @param \Looker\Model\IntegrationRequiredField[] $required_fields A list of descriptions of required fields that this integration is compatible with. If there are multiple entries in this list, the integration requires more than one field.
     *
     * @return $this
     */
