...
class DBConnection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'dialect' => '\Looker\Model\Dialect',
        'snippets' => '\Looker\Model\Snippet[]',
        'host' => 'string',
        'port' => 'string',
        'username' => 'string',
        'password' => 'string',
        ...
        'pdt_context_override' => '\Looker\Model\DBConnectionOverride',
        'can' => 'map[string,bool]'
    ];
     ...
     * Sets dialect
     *
     * @param \Looker\Model\Dialect $dialect (Read-only) SQL Dialect details
     *
     * @return $this
     */
     ...
     * Sets snippets
     *
     * @param \Looker\Model\Snippet[] $snippets SQL Runner snippets for this connection
     *
     * @return $this
     */
     ...
     *
     * @return \Looker\Model\DBConnectionOverride
     */
     ...
     *
     * @param \Looker\Model\DBConnectionOverride $pdt_context_override db_connection_override for this connection in the `pdt` maintenance context
     *
     * @return $this
     */
