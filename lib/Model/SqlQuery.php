...
class SqlQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sql' => 'string',
        'last_run_at' => 'string',
        'connection' => '\Looker\Model\DBConnectionBase',
        'model_name' => 'string',
        'creator' => '\Looker\Model\UserPublic',
        'explore_url' => 'string',
        'plaintext' => 'bool',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets connection
     *
     * @return \Looker\Model\DBConnectionBase
     */
     ...
     * Sets connection
     *
     * @param \Looker\Model\DBConnectionBase $connection Connection this query uses
     *
     * @return $this
     */
     ...
     * Sets creator
     *
     * @param \Looker\Model\UserPublic $creator User who created this SQL query
     *
     * @return $this
     */
