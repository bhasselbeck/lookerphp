...
class LookmlModelExploreField implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'enumerations' => '\Looker\Model\LookmlModelExploreFieldEnumeration[]',
        'error' => 'string',
        ...
        'time_interval' => '\Looker\Model\LookmlModelExploreFieldTimeInterval',
        'label' => 'string',
        'label_from_parameter' => 'string',
        'label_short' => 'string',
        'lookml_link' => 'string',
        'map_layer' => '\Looker\Model\LookmlModelExploreFieldMapLayer',
        'measure' => 'bool',
        'name' => 'string',
        'parameter' => 'bool',
        'permanent' => 'bool',
        ...
        'sql' => 'string',
        'sql_case' => '\Looker\Model\LookmlModelExploreFieldSqlCase[]',
     ...
     * Gets enumerations
     *
     * @return \Looker\Model\LookmlModelExploreFieldEnumeration[]
     */
     ...
     * Sets enumerations
     *
     * @param \Looker\Model\LookmlModelExploreFieldEnumeration[] $enumerations An array enumerating all the possible values that this field can contain. When null, there is no limit to the set of possible values this field can contain.
     *
     * @return $this
     */
     ...
     * Gets time_interval
     *
     * @return \Looker\Model\LookmlModelExploreFieldTimeInterval
     */
     ...
     * Sets time_interval
     *
     * @param \Looker\Model\LookmlModelExploreFieldTimeInterval $time_interval Details on the time interval this field represents, if it is_timeframe.
     *
     * @return $this
     */
     ...
     * Gets map_layer
     *
     * @return \Looker\Model\LookmlModelExploreFieldMapLayer
     */
     ...
     * Sets map_layer
     *
     * @param \Looker\Model\LookmlModelExploreFieldMapLayer $map_layer If applicable, a map layer this field is associated with.
     *
     * @return $this
     */
     ...
     * Gets sql_case
     *
     * @return \Looker\Model\LookmlModelExploreFieldSqlCase[]
     */
     ...
     * Sets sql_case
     *
     * @param \Looker\Model\LookmlModelExploreFieldSqlCase[] $sql_case An array of conditions and values that make up a SQL Case expression, as defined in the LookML model. This will be null if the current user does not have the see_lookml permission for the field's model.
     *
     * @return $this
     */
