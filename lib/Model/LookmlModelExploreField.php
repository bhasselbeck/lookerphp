...
class LookmlModelExploreField implements ModelInterface, ArrayAccess
{
     ...
     * Sets sql_case
     *
     * @param \Swagger\Client\Model\LookmlModelExploreFieldSqlCase[] $sql_case An array of conditions and values that make up a SQL Case expression, as defined in the LookML model. This will be null if the current user does not have the see_lookml permission for the field's model.
     *
     * @return $this
     */
