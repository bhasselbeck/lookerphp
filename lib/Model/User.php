...
class User implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'access_filters' => '\Looker\Model\AccessFilter[]',
        'credentials_email' => '\Looker\Model\CredentialsEmail',
        'credentials_totp' => '\Looker\Model\CredentialsTotp',
        'credentials_ldap' => '\Looker\Model\CredentialsLDAP',
        'credentials_google' => '\Looker\Model\CredentialsGoogle',
        'credentials_saml' => '\Looker\Model\CredentialsSaml',
        'credentials_oidc' => '\Looker\Model\CredentialsOIDC',
        'credentials_api' => '\Looker\Model\CredentialsApi',
        'credentials_api3' => '\Looker\Model\CredentialsApi3[]',
        'credentials_embed' => '\Looker\Model\CredentialsEmbed[]',
        'credentials_looker_openid' => '\Looker\Model\CredentialsLookerOpenid',
        'sessions' => '\Looker\Model\Session[]',
        'role_ids' => 'int[]',
        'group_ids' => 'int[]',
     ...
     * Sets access_filters
     *
     * @param \Looker\Model\AccessFilter[] $access_filters Model access filters.
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsEmail $credentials_email Email/Password login credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsTotp $credentials_totp Two-factor credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsLDAP $credentials_ldap LDAP credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsGoogle $credentials_google Google auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsSaml $credentials_saml Saml auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsOIDC $credentials_oidc OpenID Connect auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsApi $credentials_api API user credentials. NO LONGER SUPPORTED.
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsApi3[] $credentials_api3 API 3 credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsEmbed[] $credentials_embed Embed credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Looker\Model\CredentialsLookerOpenid $credentials_looker_openid LookerOpenID credentials. Used for login by Looker Analysts
     *
     * @return $this
     */
     ...
     * Sets sessions
     *
     * @param \Looker\Model\Session[] $sessions Active sessions
     *
     * @return $this
     */
