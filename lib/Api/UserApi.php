...
class UserApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AccessFilter[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allUserAccessFiltersWithHttpInfo($user_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\AccessFilter[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AccessFilter[]',
     ...
     *
     * @param  int $user_id id of user (required)
     * @param  \Swagger\Client\Model\AccessFilter $body Access Filter (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $user_id Id of user (required)
     * @param  \Swagger\Client\Model\CredentialsApi $body API Credential (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CredentialsApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUserCredentialsApiWithHttpInfo($user_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\CredentialsApi';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CredentialsApi',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $user_id id of user (required)
     * @param  int $access_filter_id id of Access Filter (required)
     * @param  \Swagger\Client\Model\AccessFilter $body Access Filter (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
