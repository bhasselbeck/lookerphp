...
class RunningQueriesApi
{
     ...
     * @return \Looker\Model\RunningQueries[]
     */
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\RunningQueries[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allRunningQueriesWithHttpInfo()
    {
        $returnType = '\Looker\Model\RunningQueries[]';
