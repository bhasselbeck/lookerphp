...
class ConnectionApi
{
     ...
     * @return \Looker\Model\DBConnection[]
     */
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\DBConnection[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allConnectionsWithHttpInfo($fields = null)
    {
        $returnType = '\Looker\Model\DBConnection[]';
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Looker\Model\DialectInfo[]
     */
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\DialectInfo[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allDialectInfosWithHttpInfo($fields = null)
    {
        $returnType = '\Looker\Model\DialectInfo[]';
     ...
     * Create Connection
     *
     * @param  \Looker\Model\DBConnection $body Connection (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Looker\Model\DBConnection
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Looker\Model\DBConnectionTestResult[]
     */
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\DBConnectionTestResult[], HTTP status code, HTTP response headers (array of strings)
     */
    public function testConnectionWithHttpInfo($connection_name, $tests = null)
    {
        $returnType = '\Looker\Model\DBConnectionTestResult[]';
     ...
     *
     * @param  string $connection_name Name of connection (required)
     * @param  \Looker\Model\DBConnection $body Connection (required)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Looker\Model\DBConnection
