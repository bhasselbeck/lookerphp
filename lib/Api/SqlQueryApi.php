...
class SqlQueryApi
{
     ...
     *
     * @param  \Looker\Model\SqlQueryCreate $body SQL Runner Query (required)
     *
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\SqlQuery, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSqlQueryWithHttpInfo($body)
    {
        $returnType = '\Looker\Model\SqlQuery';
