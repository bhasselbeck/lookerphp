...
class LookApi
{
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\Look[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allLooksWithHttpInfo($fields = null)
    {
        $returnType = '\Looker\Model\Look[]';
     ...
     * Create Look
     *
     * @param  \Looker\Model\LookWithQuery $body Look (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $look_id Id of look (required)
     * @param  \Looker\Model\LookWithQuery $body Look (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
