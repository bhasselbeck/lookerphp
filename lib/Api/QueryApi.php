...
class QueryApi
{
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\MergeQuery, HTTP status code, HTTP response headers (array of strings)
     */
    public function createMergeQueryWithHttpInfo($body = null, $fields = null)
    {
        $returnType = '\Looker\Model\MergeQuery';
     ...
     * Create Query
     *
     * @param  \Looker\Model\Query $body Query (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\Query, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * Run Query Async
     *
     * @param  \Looker\Model\CreateQueryTask $body Query parameters (required)
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\QueryTask, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \Looker\Model\Query $body inline query (required)
     * @param  int $limit Row limit (may override the limit in the saved query). (optional)
     * @param  bool $apply_formatting Apply model-specified formatting to each result. (optional)
     * @param  bool $apply_vis Apply visualization options to results. (optional)
     * @param  bool $cache Get results from cache if available. (optional)
