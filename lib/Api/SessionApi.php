...
class SessionApi
{
     ...
     * @return \Looker\Model\ApiSession
     */
     ...
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Looker\Model\ApiSession, HTTP status code, HTTP response headers (array of strings)
     */
    public function sessionWithHttpInfo()
    {
        $returnType = '\Looker\Model\ApiSession';
     ...
     * Update Session
     *
     * @param  \Looker\Model\ApiSession $body Session (required)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Looker\Model\ApiSession
