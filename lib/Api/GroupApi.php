...
class GroupApi
{
     ...
     * @param  \Looker\Model\GroupIdForGroupInclusion $body Group id to add (optional)
     *
     ...
     *
     * @param  int $group_id Id of group (required)
     * @param  \Looker\Model\GroupIdForGroupUserInclusion $body User id to add (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create Group
     *
     * @param  \Looker\Model\Group $body Group (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $group_id Id of group (required)
     * @param  \Looker\Model\Group $body Group (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  int $group_id Id of group (required)
     * @param  int $user_attribute_id Id of user attribute (required)
     * @param  \Looker\Model\UserAttributeGroupValue $body New value for group. (required)
     *
     * @throws \Looker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
