 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CredentialsEmbed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CredentialsEmbed';
     ...
     *
     * @param string $external_user_id Embedder's unique id for the user
     *
     * @return $this
     */
     ...
     *
     * @param string $external_group_id Embedder's id for a group to which this user was added during the most recent login
     *
     * @return $this
     */
