...
class OIDCConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'groups' => '\Swagger\Client\Looker\Model\OIDCGroupRead[]',
        'groups_with_role_ids' => '\Swagger\Client\Looker\Model\OIDCGroupWrite[]',
        'auth_requires_role' => 'bool',
        'user_attributes' => '\Swagger\Client\Looker\Model\OIDCUserAttributeRead[]',
        'user_attributes_with_ids' => '\Swagger\Client\Looker\Model\OIDCUserAttributeWrite[]',
        'url' => 'string',
        'can' => 'map[string,bool]'
    ];
     ...
     *
     * @param \Swagger\Client\Looker\Model\Role[] $default_new_user_roles (Read-only) Roles that will be applied to new users the first time they login via OIDC
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\Group[] $default_new_user_groups (Read-only) Groups that will be applied to new users the first time they login via OIDC
     *
     * @return $this
     */
     ...
     * Gets groups
     *
     * @return \Swagger\Client\Looker\Model\OIDCGroupRead[]
     */
     ...
     * Sets groups
     *
     * @param \Swagger\Client\Looker\Model\OIDCGroupRead[] $groups (Read-only) Array of mappings between OIDC Groups and Looker Roles
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\OIDCGroupWrite[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\OIDCGroupWrite[] $groups_with_role_ids (Read/Write) Array of mappings between OIDC Groups and arrays of Looker Role ids
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\OIDCUserAttributeRead[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\OIDCUserAttributeRead[] $user_attributes (Read-only) Array of mappings between OIDC User Attributes and Looker User Attributes
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\OIDCUserAttributeWrite[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\OIDCUserAttributeWrite[] $user_attributes_with_ids (Read/Write) Array of mappings between OIDC User Attributes and arrays of Looker User Attribute ids
     *
     * @return $this
     */
