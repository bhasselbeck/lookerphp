...
/**
 * CredentialsSaml Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CredentialsSaml implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CredentialsSaml';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['saml_user_id'] = isset($data['saml_user_id']) ? $data['saml_user_id'] : null;
    ...
    {
        return $this->container['saml_user_id'];
    }

    /**
     * Sets saml_user_id
     *
     * @param string $saml_user_id Saml IdP's Unique ID for this user
     *
     * @return $this
     */
    public function setSamlUserId($saml_user_id)
    {
        $this->container['saml_user_id'] = $saml_user_id;
