...
class LookmlModelExploreField implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'enumerations' => '\Swagger\Client\Looker\Model\LookmlModelExploreFieldEnumeration[]',
        'error' => 'string',
        ...
        'time_interval' => '\Swagger\Client\Looker\Model\LookmlModelExploreFieldTimeInterval',
        'label' => 'string',
        'label_from_parameter' => 'string',
        'label_short' => 'string',
        'lookml_link' => 'string',
        'map_layer' => '\Swagger\Client\Looker\Model\LookmlModelExploreFieldMapLayer',
        'measure' => 'bool',
        'name' => 'string',
        'parameter' => 'bool',
        'permanent' => 'bool',
        ...
        'sql' => 'string',
        'sql_case' => '\Swagger\Client\Looker\Model\LookmlModelExploreFieldSqlCase[]',
     ...
     * Gets enumerations
     *
     * @return \Swagger\Client\Looker\Model\LookmlModelExploreFieldEnumeration[]
     */
     ...
     * Sets enumerations
     *
     * @param \Swagger\Client\Looker\Model\LookmlModelExploreFieldEnumeration[] $enumerations An array enumerating all the possible values that this field can contain. When null, there is no limit to the set of possible values this field can contain.
     *
     * @return $this
     */
     ...
     * Gets time_interval
     *
     * @return \Swagger\Client\Looker\Model\LookmlModelExploreFieldTimeInterval
     */
     ...
     * Sets time_interval
     *
     * @param \Swagger\Client\Looker\Model\LookmlModelExploreFieldTimeInterval $time_interval Details on the time interval this field represents, if it is_timeframe.
     *
     * @return $this
     */
     ...
     * Gets map_layer
     *
     * @return \Swagger\Client\Looker\Model\LookmlModelExploreFieldMapLayer
     */
     ...
     * Sets map_layer
     *
     * @param \Swagger\Client\Looker\Model\LookmlModelExploreFieldMapLayer $map_layer If applicable, a map layer this field is associated with.
     *
     * @return $this
     */
     ...
     * Sets sql
     *
     * @param string $sql SQL expression as defined in the LookML model. This will be null if the current user does not have the see_lookml permission for the field's model.
     *
     * @return $this
     */
     ...
     * Gets sql_case
     *
     * @return \Swagger\Client\Looker\Model\LookmlModelExploreFieldSqlCase[]
     */
     ...
     * Sets sql_case
     *
     * @param \Swagger\Client\Looker\Model\LookmlModelExploreFieldSqlCase[] $sql_case An array of conditions and values that make up a SQL Case expression, as defined in the LookML model. This will be null if the current user does not have the see_lookml permission for the field's model.
     *
     * @return $this
     */
