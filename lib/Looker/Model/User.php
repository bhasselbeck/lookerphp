...
class User implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'access_filters' => '\Swagger\Client\Looker\Model\AccessFilter[]',
        'credentials_email' => '\Swagger\Client\Looker\Model\CredentialsEmail',
        'credentials_totp' => '\Swagger\Client\Looker\Model\CredentialsTotp',
        'credentials_ldap' => '\Swagger\Client\Looker\Model\CredentialsLDAP',
        'credentials_google' => '\Swagger\Client\Looker\Model\CredentialsGoogle',
        'credentials_saml' => '\Swagger\Client\Looker\Model\CredentialsSaml',
        'credentials_oidc' => '\Swagger\Client\Looker\Model\CredentialsOIDC',
        'credentials_api' => '\Swagger\Client\Looker\Model\CredentialsApi',
        'credentials_api3' => '\Swagger\Client\Looker\Model\CredentialsApi3[]',
        'credentials_embed' => '\Swagger\Client\Looker\Model\CredentialsEmbed[]',
        'credentials_looker_openid' => '\Swagger\Client\Looker\Model\CredentialsLookerOpenid',
        'sessions' => '\Swagger\Client\Looker\Model\Session[]',
        'role_ids' => 'int[]',
        'group_ids' => 'int[]',
     ...
     * Sets access_filters
     *
     * @param \Swagger\Client\Looker\Model\AccessFilter[] $access_filters Model access filters.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsEmail $credentials_email Email/Password login credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsTotp $credentials_totp Two-factor credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsLDAP $credentials_ldap LDAP credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsGoogle $credentials_google Google auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsSaml $credentials_saml Saml auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsOIDC $credentials_oidc OpenID Connect auth credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsApi $credentials_api API user credentials. NO LONGER SUPPORTED.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsApi3[] $credentials_api3 API 3 credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsEmbed[] $credentials_embed Embed credentials
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\CredentialsLookerOpenid $credentials_looker_openid LookerOpenID credentials. Used for login by Looker Analysts
     *
     * @return $this
     */
     ...
     * Sets sessions
     *
     * @param \Swagger\Client\Looker\Model\Session[] $sessions Active sessions
     *
     * @return $this
     */
