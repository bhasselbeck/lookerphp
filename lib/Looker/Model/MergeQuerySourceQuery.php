 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MergeQuerySourceQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MergeQuerySourceQuery';
    ...
    protected static $swaggerTypes = [
        'query_id' => 'int',
        'name' => 'string',
        'merge_fields' => '\Swagger\Client\Looker\Model\MergeFields[]',
        'can' => 'map[string,bool]'
    ];
     ...
     * Sets query_id
     *
     * @param int $query_id Id of the query to merge
     *
     * @return $this
     */
     ...
     * Gets merge_fields
     *
     * @return \Swagger\Client\Looker\Model\MergeFields[]
     */
     ...
     * Sets merge_fields
     *
     * @param \Swagger\Client\Looker\Model\MergeFields[] $merge_fields An array defining which fields of the source query are mapped onto fields of the merge query
     *
     * @return $this
     */
