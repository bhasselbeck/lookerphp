...
class DBConnection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'dialect' => '\Swagger\Client\Looker\Model\Dialect',
        'snippets' => '\Swagger\Client\Looker\Model\Snippet[]',
        'host' => 'string',
        'port' => 'string',
        'username' => 'string',
        'password' => 'string',
        ...
        'pdt_context_override' => '\Swagger\Client\Looker\Model\DBConnectionOverride',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets dialect
     *
     * @return \Swagger\Client\Looker\Model\Dialect
     */
     ...
     * Sets dialect
     *
     * @param \Swagger\Client\Looker\Model\Dialect $dialect (Read-only) SQL Dialect details
     *
     * @return $this
     */
     ...
     * Gets snippets
     *
     * @return \Swagger\Client\Looker\Model\Snippet[]
     */
     ...
     * Sets snippets
     *
     * @param \Swagger\Client\Looker\Model\Snippet[] $snippets SQL Runner snippets for this connection
     *
     * @return $this
     */
     ...
     *
     * @param bool $user_db_credentials (Limited access feature) Are per user db credentials enabled
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\DBConnectionOverride
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\DBConnectionOverride $pdt_context_override db_connection_override for this connection in the `pdt` maintenance context
     *
     * @return $this
     */
