...
/**
 * CredentialsLookerOpenid Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CredentialsLookerOpenid implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CredentialsLookerOpenid';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['logged_in_ip'] = isset($data['logged_in_ip']) ? $data['logged_in_ip'] : null;
     ...
     * @return string
     */
    public function getLoggedInIp()
    {
        return $this->container['logged_in_ip'];
    }

    /**
     * Sets logged_in_ip
     *
     * @param string $logged_in_ip IP address of client for most recent login using credential
     *
     * @return $this
     */
    public function setLoggedInIp($logged_in_ip)
    {
        $this->container['logged_in_ip'] = $logged_in_ip;
