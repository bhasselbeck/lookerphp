...
class LDAPConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'groups' => '\Swagger\Client\Looker\Model\LDAPGroupRead[]',
        'groups_with_role_ids' => '\Swagger\Client\Looker\Model\LDAPGroupWrite[]',
        ...
        'user_attributes' => '\Swagger\Client\Looker\Model\LDAPUserAttributeRead[]',
        'user_attributes_with_ids' => '\Swagger\Client\Looker\Model\LDAPUserAttributeWrite[]',
        'url' => 'string',
        'can' => 'map[string,bool]'
    ];
     ...
     *
     * @param \Swagger\Client\Looker\Model\Group[] $default_new_user_groups (Read-only) Groups that will be applied to new users the first time they login via LDAP
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\Role[] $default_new_user_roles (Read-only) Roles that will be applied to new users the first time they login via LDAP
     *
     * @return $this
     */
     ...
     * Gets groups
     *
     * @return \Swagger\Client\Looker\Model\LDAPGroupRead[]
     */
     ...
     * Sets groups
     *
     * @param \Swagger\Client\Looker\Model\LDAPGroupRead[] $groups (Read-only) Array of mappings between LDAP Groups and Looker Roles
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\LDAPGroupWrite[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\LDAPGroupWrite[] $groups_with_role_ids (Read/Write) Array of mappings between LDAP Groups and arrays of Looker Role ids
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\LDAPUserAttributeRead[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\LDAPUserAttributeRead[] $user_attributes (Read-only) Array of mappings between LDAP User Attributes and Looker User Attributes
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Looker\Model\LDAPUserAttributeWrite[]
     */
     ...
     *
     * @param \Swagger\Client\Looker\Model\LDAPUserAttributeWrite[] $user_attributes_with_ids (Read/Write) Array of mappings between LDAP User Attributes and arrays of Looker User Attribute ids
     *
     * @return $this
     */
