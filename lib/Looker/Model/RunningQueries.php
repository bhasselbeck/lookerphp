...
class RunningQueries implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'user' => '\Swagger\Client\Looker\Model\UserPublic',
        'query' => '\Swagger\Client\Looker\Model\Query',
        'sql_query' => '\Swagger\Client\Looker\Model\SqlQuery',
        'look' => '\Swagger\Client\Looker\Model\LookBasic',
        'created_at' => 'string',
        'completed_at' => 'string',
        'query_id' => 'string',
        'source' => 'string',
     ...
     * Gets user
     *
     * @return \Swagger\Client\Looker\Model\UserPublic
     */
     ...
     * Sets user
     *
     * @param \Swagger\Client\Looker\Model\UserPublic $user User who initiated the query
     *
     * @return $this
     */
     ...
     * Sets query
     *
     * @param \Swagger\Client\Looker\Model\Query $query Query that was run
     *
     * @return $this
     */
     ...
     * Gets sql_query
     *
     * @return \Swagger\Client\Looker\Model\SqlQuery
     */
     ...
     * Sets sql_query
     *
     * @param \Swagger\Client\Looker\Model\SqlQuery $sql_query SQL Query that was run
     *
     * @return $this
     */
     ...
     * Gets look
     *
     * @return \Swagger\Client\Looker\Model\LookBasic
     */
     ...
     * Sets look
     *
     * @param \Swagger\Client\Looker\Model\LookBasic $look Look of query that was run
     *
     * @return $this
     */
