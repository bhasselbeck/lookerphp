...
class SqlQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sql' => 'string',
        'last_run_at' => 'string',
        'connection' => '\Swagger\Client\Looker\Model\DBConnectionBase',
        'model_name' => 'string',
        'creator' => '\Swagger\Client\Looker\Model\UserPublic',
        'explore_url' => 'string',
        'plaintext' => 'bool',
        'can' => 'map[string,bool]'
    ];
     ...
     * Gets connection
     *
     * @return \Swagger\Client\Looker\Model\DBConnectionBase
     */
     ...
     * Sets connection
     *
     * @param \Swagger\Client\Looker\Model\DBConnectionBase $connection Connection this query uses
     *
     * @return $this
     */
     ...
     * Sets creator
     *
     * @param \Swagger\Client\Looker\Model\UserPublic $creator User who created this SQL query
     *
     * @return $this
     */
