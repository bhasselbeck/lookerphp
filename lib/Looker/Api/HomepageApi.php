...
class HomepageApi
{
     ...
     * @return \Swagger\Client\Looker\Model\HomepageItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\HomepageItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allHomepageItemsWithHttpInfo($fields = null, $sorts = null, $homepage_section_id = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\HomepageItem[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\HomepageItem[]',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\HomepageSection[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\HomepageSection[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allHomepageSectionsWithHttpInfo($fields = null, $sorts = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\HomepageSection[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\HomepageSection[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Looker\Model\HomepageItem $body Homepage Item (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Looker\Model\HomepageSection $body Homepage section (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $homepage_item_id Id of homepage item (required)
     * @param  \Swagger\Client\Looker\Model\HomepageItem $body Homepage Item (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $homepage_section_id Id of homepage section (required)
     * @param  \Swagger\Client\Looker\Model\HomepageSection $body Homepage section (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
