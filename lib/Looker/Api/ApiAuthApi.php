...
class ApiAuthApi
{
     ...
     * @return \Swagger\Client\Looker\Model\AccessToken
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\AccessToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginWithHttpInfo($client_id = null, $client_secret = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\AccessToken';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\AccessToken',
