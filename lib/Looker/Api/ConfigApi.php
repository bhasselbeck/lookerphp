...
class ConfigApi
{
     ...
     * @return \Swagger\Client\Looker\Model\LegacyFeature[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\LegacyFeature[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allLegacyFeaturesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Looker\Model\LegacyFeature[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\LegacyFeature[]',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\Timezone[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\Timezone[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allTimezonesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Looker\Model\Timezone[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\Timezone[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\BackupConfiguration
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\BackupConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function backupConfigurationWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Looker\Model\BackupConfiguration';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\BackupConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Looker\Model\BackupConfiguration $body Options for Backup Configuration (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\BackupConfiguration
     ...
     *
     * @param  int $legacy_feature_id id of legacy feature (required)
     * @param  \Swagger\Client\Looker\Model\LegacyFeature $body Legacy Feature (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\LegacyFeature
     ...
     *
     * @param  \Swagger\Client\Looker\Model\WhitelabelConfiguration $body Whitelabel configuration (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\WhitelabelConfiguration
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\WhitelabelConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWhitelabelConfigurationWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Looker\Model\WhitelabelConfiguration';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\WhitelabelConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ApiVersion
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ApiVersion, HTTP status code, HTTP response headers (array of strings)
     */
    public function versionsWithHttpInfo($fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ApiVersion';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ApiVersion',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
