...
/**
 * RunningQueriesApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class RunningQueriesApi
{
     ...
     * @return \Swagger\Client\Looker\Model\RunningQueries[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\RunningQueries[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allRunningQueriesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Looker\Model\RunningQueries[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\RunningQueries[]',
