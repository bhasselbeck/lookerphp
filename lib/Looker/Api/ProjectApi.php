...
class ProjectApi
{
     ...
     * @return \Swagger\Client\Looker\Model\GitBranch[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\GitBranch[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allGitBranchesWithHttpInfo($project_id)
    {
        $returnType = '\Swagger\Client\Looker\Model\GitBranch[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\GitBranch[]',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\GitConnectionTest[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\GitConnectionTest[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allGitConnectionTestsWithHttpInfo($project_id)
    {
        $returnType = '\Swagger\Client\Looker\Model\GitConnectionTest[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\GitConnectionTest[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ProjectFile[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ProjectFile[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allProjectFilesWithHttpInfo($project_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ProjectFile[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ProjectFile[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\Project[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\Project[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allProjectsWithHttpInfo($fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\Project[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\Project[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create Project
     *
     * @param  \Swagger\Client\Looker\Model\Project $body Project (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\Project
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ProjectValidationCache
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ProjectValidationCache, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectValidationResultsWithHttpInfo($project_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ProjectValidationCache';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ProjectValidationCache',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ProjectWorkspace
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ProjectWorkspace, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectWorkspaceWithHttpInfo($project_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ProjectWorkspace';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ProjectWorkspace',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\GitConnectionTestResult
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\GitConnectionTestResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function runGitConnectionTestWithHttpInfo($project_id, $test_id)
    {
        $returnType = '\Swagger\Client\Looker\Model\GitConnectionTestResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\GitConnectionTestResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $project_id Project Id (required)
     * @param  \Swagger\Client\Looker\Model\Project $body Project (required)
     * @param  string $fields Requested fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ProjectValidation
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ProjectValidation, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateProjectWithHttpInfo($project_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ProjectValidation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ProjectValidation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
