...
class SqlQueryApi
{
     ...
     *
     * @param  \Swagger\Client\Looker\Model\SqlQueryCreate $body SQL Runner Query (required)
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\SqlQuery, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSqlQueryWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Looker\Model\SqlQuery';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\SqlQuery',
