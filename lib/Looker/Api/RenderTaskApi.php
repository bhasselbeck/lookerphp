...
class RenderTaskApi
{
     ...
     * @param  \Swagger\Client\Looker\Model\CreateDashboardRenderTask $body Dashboard render task parameters (required)
     ...
     * @return \Swagger\Client\Looker\Model\RenderTask
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\RenderTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDashboardRenderTaskWithHttpInfo($dashboard_id, $result_format, $body, $width, $height, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\RenderTask';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\RenderTask',
