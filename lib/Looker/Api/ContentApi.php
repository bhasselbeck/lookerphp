...
class ContentApi
{
     ...
     * @return \Swagger\Client\Looker\Model\ContentMetaGroupUser[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ContentMetaGroupUser[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allContentMetadataAccesssWithHttpInfo($content_metadata_id = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ContentMetaGroupUser[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ContentMetaGroupUser[]',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentMeta[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ContentMeta[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allContentMetadatasWithHttpInfo($parent_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ContentMeta[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ContentMeta[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentFavorite
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ContentFavorite, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentFavoriteWithHttpInfo($content_favorite_id, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\ContentFavorite';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ContentFavorite',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Looker\Model\ContentFavorite $body Favorite Content (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentFavorite
     ...
     *
     * @param  \Swagger\Client\Looker\Model\ContentMetaGroupUser $body Content Metadata Access (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentMetaGroupUser
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentView[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\ContentView[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Looker\Model\ContentView[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\ContentView[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $content_metadata_id Id of content metadata (required)
     * @param  \Swagger\Client\Looker\Model\ContentMeta $body Content Metadata (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentMeta
     ...
     *
     * @param  int $content_metadata_access_id Id of content metadata access (required)
     * @param  \Swagger\Client\Looker\Model\ContentMetaGroupUser $body Content Metadata Access (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\ContentMetaGroupUser
