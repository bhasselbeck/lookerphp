...
class LookApi
{
     ...
     * @return \Swagger\Client\Looker\Model\Look[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\Look[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allLooksWithHttpInfo($fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\Look[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\Look[]',
     ...
     * Create Look
     *
     * @param  \Swagger\Client\Looker\Model\LookWithQuery $body Look (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $look_id Id of look (required)
     * @param  \Swagger\Client\Looker\Model\LookWithQuery $body Look (required)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
