...
class LookmlModelApi
{
     ...
     * @return \Swagger\Client\Looker\Model\LookmlModel[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\LookmlModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allLookmlModelsWithHttpInfo($fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\LookmlModel[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\LookmlModel[]',
     ...
     * Create LookML Model
     *
     * @param  \Swagger\Client\Looker\Model\LookmlModel $body LookML Model (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\LookmlModel
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\LookmlModelExplore
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Looker\Model\LookmlModelExplore, HTTP status code, HTTP response headers (array of strings)
     */
    public function lookmlModelExploreWithHttpInfo($lookml_model_name, $explore_name, $fields = null)
    {
        $returnType = '\Swagger\Client\Looker\Model\LookmlModelExplore';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Looker\Model\LookmlModelExplore',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $lookml_model_name Name of lookml model. (required)
     * @param  \Swagger\Client\Looker\Model\LookmlModel $body LookML Model (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Looker\Model\LookmlModel
